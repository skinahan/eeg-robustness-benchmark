...
from cnnncp import _MultiScaleTemporalBlock1D, _SNRGate
...
class DIVANCP(EEGModuleMixin, nn.Module):
    ...
    def __init__(
        ...
        # Q: Do we need to explicitly clip the weight to be between 0 and 1?
        # A: No, because the optimizer will handle it.
        # Can we use numpy generator to initialize the weight?
        # A: Yes, but we need to convert it to a tensor first.
