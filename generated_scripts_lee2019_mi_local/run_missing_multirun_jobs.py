...
Generated on: 2026-03-29 14:08:05
...
from evaluation.unified_experiment_runner import UnifiedExperimentRunner, _resolve_lee2019_mi_train_sliding_window
...
def run_single_experiment(exp_config: Dict[str, Any], job_num: int, total_jobs: int) -> Tuple[int, bool, Optional[str], float]:
    ...
    try:
        lee2019_sw = _resolve_lee2019_mi_train_sliding_window(exp_config.get('pipeline'), False)
        ...
        runner = UnifiedExperimentRunner(
            ...
            pipeline=exp_config.get('pipeline'),
            lee2019_mi_train_sliding_window=lee2019_sw,
        )
    ...
    non_tuned_experiments = [
        {
            ...
            'model': 'eegnet',
            'seed': 100,
            'pipeline': {'resample': 128.0, 'train_sliding_window': True},
