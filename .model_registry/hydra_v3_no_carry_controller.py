"""
Auto-generated registration file for hydra_v3_no_carry_controller
"""
import sys
...
feature_config = {'controller_dim': 1, 'use_cfc_carry_controller': False, 'use_ssvep_head': True}
...
_runtime_model_registry["hydra_v3_no_carry_controller"] = factory

# Also register in MODEL_REGISTRY for backward compatibility
MODEL_REGISTRY["hydra_v3_no_carry_controller"] = factory
