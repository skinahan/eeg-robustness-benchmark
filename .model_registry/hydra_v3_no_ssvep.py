"""
Auto-generated registration file for hydra_v3_no_ssvep
"""
import sys
...
feature_config = {'controller_dim': 1, 'use_cfc_carry_controller': True, 'use_ssvep_head': False}
...
_runtime_model_registry["hydra_v3_no_ssvep"] = factory

# Also register in MODEL_REGISTRY for backward compatibility
MODEL_REGISTRY["hydra_v3_no_ssvep"] = factory
