...
def remove_wiredcfc_architecture(architecture_name):
    ...
    try:
        if architecture_name in _wiredcfc_architecture_registry:
            ...
            print(f"⚠️ Architecture {architecture_name} not found in registry")
            return False
...
def initialize_default_architectures():
    ...
    if loaded_count > 0:
        ...
        print("⚠️ No default architectures found, use load_architectures_from_directory() to load them")
