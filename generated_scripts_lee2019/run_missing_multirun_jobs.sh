...
# Generated on: 2025-09-29 11:46:42
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 22 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 10 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 5 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 10 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 16 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 26 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 9 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 17 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 25 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 17 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 8 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 18 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 16 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 19 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 7 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 1 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 2 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 27 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 20 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 11 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 20 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 19 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 10 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 2 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 26 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 3 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 3 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 14 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 9 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 17 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 18 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 26 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 21 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 6 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 1 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 9 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 20 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 11 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 18 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 13 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 4 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 13 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 24 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 1 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 12 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 12 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 23 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 3 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 23 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 11 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 14 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 15 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 15 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 21 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 6 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 14 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 13 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 21 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 4 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 24 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 6 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 12 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 22 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 23 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 22 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 5 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 5 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 16 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 4 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 24 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 15 Lee2019_SSVEP CrossSession false eegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 25 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 25 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 8 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 8 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 19 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 7 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 7 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 2 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 27 Lee2019_SSVEP CrossSession false cnn_ncp
if [ $? -eq 0 ]; then
...
sbatch --time=0-06:00:00 --mem=12G unified_eval_script.sh 27 Lee2019_SSVEP CrossSession false reegnet
if [ $? -eq 0 ]; then
